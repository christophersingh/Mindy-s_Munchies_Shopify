var AT_Slider ={
    ...
    owlSlider : function(){
      	...
      	jQuery(".sb-product-list-1").length && jQuery('.sb-product-list-1').owlCarousel({
          	autoplay	: true
          	,loop 		: true
          	,nav		: true
          	,dots 		: false
        ...
        jQuery(".sb-product-list-2").length && jQuery('.sb-product-list-2').owlCarousel({
          	autoplay	: true	
          	,loop 		: true
          	,dots 		: true
      		,items		: 1
      	...
      	jQuery(".sb-product-list-3").length && jQuery('.sb-product-list-3').owlCarousel({
          	autoplay	: true
          	,loop 		: true
          	,nav		: true
          	,dots 		: false
      	...
      	jQuery(".testimonial-list").length && jQuery('.testimonial-list').owlCarousel({
          	autoplay	: true	
          	,loop 		: true
          	,dots 		: true
      		,items		: 1
